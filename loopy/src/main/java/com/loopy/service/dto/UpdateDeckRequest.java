...
public class UpdateDeckRequest {
    ...
    @JsonSetter("isPublic")
    public void setPublic(Boolean isPublic) { this.isPublic = isPublic; this.publicPresent = true; }

    public boolean hasChanges() { return namePresent || descriptionPresent || publicPresent; }
}
